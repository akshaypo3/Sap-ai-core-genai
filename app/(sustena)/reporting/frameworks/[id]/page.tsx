      ...
      <ContentLayout title={t("fe_assessments.assessments")}>
        ...
        <div className="p-5 border rounded">
          <div className="flex justify-between">
            ...
            <AnswerButton QuestionData={assessemetquestion1}/>
            <AnswerButton QuestionData={assessemetquestion2}/>
            <AnswerButton QuestionData={assessemetquestion3}/>
            <AnswerButton QuestionData={assessemetquestion4}/>
            <AnswerButton QuestionData={assessemetquestion5}/>
