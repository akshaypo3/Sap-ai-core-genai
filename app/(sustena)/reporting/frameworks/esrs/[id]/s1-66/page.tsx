...
import SampleQuestion3 from "@/components/reporting/frameworks/demo/sampleQuestion3";
...
if (roleforpage === "Stakeholder" || typeof roleforpage === 'undefined') {
  ...
  const breadcrumbs = [
    { href: "/dashboard/", text: t("frameworks.esrs.s1-66.Home") }
  ];
  return (
    <>
      <ContentLayout title={t("frameworks.esrs.s1-66.title")}>
        <div className="mb-8 p-10 flex items-center justify-between bg-white dark:bg-neutral-950 rounded-md border">
          <BreadCrumbCom title={t("frameworks.esrs.s1-66.Materiality Dashboard")} breadcrumbs={breadcrumbs} backButton={<BackButton/>}/>
