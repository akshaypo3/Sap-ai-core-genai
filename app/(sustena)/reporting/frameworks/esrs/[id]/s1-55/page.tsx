...
import SampleQuestion2 from "@/components/reporting/frameworks/demo/sampleQuestion2";
...
export default async function Page() {
  ...
  const breadcrumbs = [
    { href: "/dashboard/", text: t("frameworks.esrs.s1-55.Home") }
  ];
  return (
<>
<ContentLayout title={t("frameworks.esrs.s1-55.title")}>
  <div className="mb-8 p-10 flex items-center justify-between bg-white dark:bg-neutral-950 rounded-md border">
    <BreadCrumbCom title={t("frameworks.esrs.s1-55.Materiality Dashboard")} breadcrumbs={breadcrumbs} backButton={<BackButton/>}/>
