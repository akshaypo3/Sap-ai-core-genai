...
export interface ReusableBarChartInteractiveProps {
  data: DataPoint[];
  config: {
...
const ReusableBarChartInteractive: React.FC<ReusableBarChartInteractiveProps> = ({ 
  data, 
  config, 
  title, 
  description, 
...
export default ReusableBarChartInteractive