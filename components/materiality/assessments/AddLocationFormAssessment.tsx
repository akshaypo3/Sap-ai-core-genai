...
import { addLocationAssessment } from '@/lib/company/action';

export default async function AddLocationForm(id:any) {
    const assessmentId = id.id;
    const locationTypes = await getLocationTypes();
    const countries = await getCountries();

    console.log("Assessment id inside Form: ",assessmentId)

    return (
        <form action={addLocationAssessment}>
