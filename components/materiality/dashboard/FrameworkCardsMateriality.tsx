...
export default function FrameworkCardsMateriality() {
  ...
  return (
    <>
    <div className="mt-10">
        <h1 className="font-bold text-lg">{t("dashboard.Available Frameworks")}</h1>
    </div>
    <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4 mt-4">
        <Card key="1" className="flex flex-col h-full">
          ...
          <CardHeader className="h-24 overflow-hidden">
            <h3 className="text-lg font-semibold line-clamp-2">{t("dashboard.ESRS for CSRD")}</h3>
          </CardHeader>
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground line-clamp-4">{t("dashboard.Identify and prioritize sustainability topics that are most relevant to stakeholders and business impact.")}</p>
          </CardContent>
          <CardFooter className="flex justify-between items-end">
            <div className="flex flex-col text-xs text-muted-foreground">
              <div className="flex items-center">
                <UserIcon className="w-3 h-3 mr-1" />
                <span>{t("dashboard.VASPP Deutschland")}</span>
              </div>
            ...
            <Link href="/materiality/assessments">
              <Button variant="outline" size="sm" className="bg-green-500 hover:bg-green-600 text-white hover:text-white ">{t("dashboard.Select")}</Button>
            </Link>
          </CardFooter>
        </Card>
        <Card key="1" className="flex flex-col h-full">
          ...
          <CardHeader className="h-24 overflow-hidden">
            <h3 className="text-lg font-semibold line-clamp-2">{t("dashboard.BRSR")}</h3>
          </CardHeader>
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground line-clamp-4">{t("dashboard.You will be directly guided to the framework for streamlined reporting and compliance.")}</p>
          </CardContent>
          <CardFooter className="flex justify-between items-end">
            <div className="flex flex-col text-xs text-muted-foreground">
              <div className="flex items-center">
