  ...
  return (
    <div className="w-full mx-auto space-y-6 pt-5">
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Overall Reporting Progress 2024</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-sm font-medium">71% Complete</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">75% of goal achieved</p>
          </CardContent>
        </Card>
