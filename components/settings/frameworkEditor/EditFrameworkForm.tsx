...
import { updateFramework } from "@/lib/settings/frameworkEditor/action";
...
export default function UpdateFrameworkEditorForm({
  open,
  setOpen,
  frameworkData,
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="grid w-full items-center gap-1.5 mb-2">
          <Input type="hidden" name="userId" value={frameworkData.userId} />
          <FormField
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="text" placeholder="1.0" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <div className="flex mt-5">
          <div className="flex-auto">
            <Button className="w-full" type="submit" disabled={isSubmitting}>
              {isSubmitting ? "Updating..." : "Update Framework"}
            </Button>
          </div>
        </div>
      </form>
