...
import { createFramework } from "@/lib/settings/frameworkEditor/action";
...
export default function CreateFrameworkEditorForm({
  open,
  setOpen,
  userId
}: CreateGlossaryFormProps) {
