...
import { upwardDownwardQuestionFormSchema } from "@/schemas/UpwardDownwardFormSchema";
import QuestionStep from "./QuestionStep";
import AnswerTypeStep from "./AnswerTypeStep";
import PreviewPanel from "./PreviewPanel";
import { upwardDownwardCreateQuestion } from "@/lib/settings/frameworkEditor/action";
...
export function UpwardDownwardQuestionFormDialog({
  open,
  setOpen,
  framework_id,
  section_id,
  ...
  const methods = useForm({
    resolver: zodResolver(upwardDownwardQuestionFormSchema),
    defaultValues: {
      questionText: "",
      answerType: "Text",
      answerOptions: [],
  ...
  const CreateQuestion = async (data) => {
    try {
      ...
      await upwardDownwardCreateQuestion(data);
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("questionData", JSON.stringify(data.questionData) || "");
