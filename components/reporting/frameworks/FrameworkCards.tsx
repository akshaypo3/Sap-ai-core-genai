  ...
  const newsItems = [
    {
      ...
      description: "Start the reporting process for CSRD with the ESRS standards",
    ...
    },
    {
      ...
      headline: "BRSR",
      description: " Start the reporting process for BRSR with SEBI standards",
    ...
    <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4 mt-4">
        <Card key="1" className="flex flex-col h-full">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground line-clamp-4">Start the reporting process for CSRD with the ESRS standards</p>
          </CardContent>
        ...
        <Card key="1" className="flex flex-col h-full">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground line-clamp-4">Start the reporting process for BRSR with SEBI standards</p>
          </CardContent>
          <CardFooter className="flex justify-between items-end">
            <div className="flex flex-col text-xs text-muted-foreground">
              <div className="flex items-center">
                <UserIcon className="w-3 h-3 mr-1" />
                <span>VASPP Technologies</span>
              </div>
              <div className="flex items-center mt-1">
                <Progress value={0}/>
              </div>
