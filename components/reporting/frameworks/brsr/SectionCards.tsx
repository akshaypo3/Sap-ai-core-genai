  ...
  return (
    ...
    <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4 mt-4">
        ...
        <Card key="2" className="flex flex-col h-full">
          ...
          <CardHeader className="h-24 overflow-hidden">
            <h3 className="text-lg font-semibold line-clamp-2">{t("MANAGEMENT AND PROECSS DISCLOSURES.title")}</h3>
          </CardHeader>
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground line-clamp-4">{t("MANAGEMENT AND PROECSS DISCLOSURES.description")}</p>
          </CardContent>
          <CardFooter className="flex justify-between items-end">
            <div className="flex flex-col text-xs text-muted-foreground">
              <div className="flex items-center">
            ...
            <Link href="">
              <Button variant="outline" size="sm">{t("MANAGEMENT AND PROECSS DISCLOSURES.buttonText")}</Button>
            </Link>
          </CardFooter>
        </Card>
