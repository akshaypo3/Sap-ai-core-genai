    ...
    <div className="w-full max-w-2xl mx-auto py-8">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-4">
          <div className="bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-md text-sm font-medium">{t("ESRS ID: S1-77")}</div>
          <div className="bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-md text-sm font-medium">{t("DR: 57b")}</div>
        ...
        <div>
          ...
          <div className="mt-2 space-y-2">
            <div>
              ...
              {t("Percentage of employee turnover")}
              </p>
            </div>
          </div>
        </div>
